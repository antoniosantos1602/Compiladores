...
public class SemanticAnalysisTest {
    ...
    @Test
    public void useThisInMain() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/UseThisInMain.jmm"));
        TestUtils.mustFail(result);
    }
    ...
    public void overall() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/Overall.jmm"));
        TestUtils.noErrors(result);
    }

    @Test
    public void callToImportedMethod() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/CallToImportedMethod.jmm"));
        TestUtils.noErrors(result);
    }
}
