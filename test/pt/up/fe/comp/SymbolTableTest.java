...
public class SymbolTableTest {
    ...
    public void NumImports() {		
		...
		System.out.println("IMPORTS: "+semantics.getSymbolTable().getImports());
    	assertEquals(2, semantics.getSymbolTable().getImports().size());
		assertEquals("io", semantics.getSymbolTable().getImports().get(0));
    }
	...
	public void TestExtra1() {
		...
		var semantics = test("symboltable/NonConspicuousTestFile2.jmm",false);
		var st = semantics.getSymbolTable();
		var methods = st.getMethods();
